...
export const CELLS: Cell[] = [
  ...
  },
  {
    ...
    name: "艾特迪\n車站",
    type: "station",
    description: "完成站長指令：全隊合作傳送補給物品到最前面",
    effect: { type: "mission", mission: "全隊合作傳送補給物品到最前面" },
    icon: "🅰️",
    color: "bg-blue-400",
  },
  {
  ...
  },
  {
    ...
    name: "提姆比爾\n德斯站",
    type: "station",
    description: "完成站長指令：台上做什麼動作，要馬上跟上",
    effect: { type: "mission", mission: "台上做什麼動作，要馬上跟上" },
    hostNote: "一起來看站長指令是什麼，show 指令",
    icon: "🤝",
    color: "bg-blue-400",
  },
